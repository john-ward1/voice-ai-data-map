...
Voice AI Data Map is a small LiveKit experiment that maps the sensitive data and third-party supply chain behind a realtime AI voice interaction.
...
Configure your LiveKit environment using `.env.local`.
...
Connect to the agent using the LiveKit Agent Console and have a voice conversation.

When the session ends, the project creates a local report under:
